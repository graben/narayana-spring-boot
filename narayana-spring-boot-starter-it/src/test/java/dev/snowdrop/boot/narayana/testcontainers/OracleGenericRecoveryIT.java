...
public class OracleGenericRecoveryIT extends GenericRecoveryIT {
    ...
    @BeforeAll
    static void all() {
        // Workaround for ORA-08177 occurring on default isolation level TRANSACTION_SERIALIZABLE
        jdbcPropertyManager.getJDBCEnvironmentBean().setIsolationLevel(Connection.TRANSACTION_READ_COMMITTED);
    }
}
